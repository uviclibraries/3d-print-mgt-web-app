...
<meta name="theme-color" content="#563d7c">
  ...
  <body class="bg-light">
    ...
    <form method="POST" enctype="multipart/form-data">
      ...
      <?php include('admin_spec_php_partials/admin_laser_cut-specific_specs_partial.php');?>
