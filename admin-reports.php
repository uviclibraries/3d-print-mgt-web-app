...
//find out what parameters are being searched for
  ...
  echo $searchline . "\n";
### Kenzie this is what is currently being generated by your code for a SQL Query:
  # SELECT * FROM moneris_fields WHERE date_stamp >= ? AND date_stamp <= ? ORDER BY id the count: 1--2020-12-01 the count: 2--2020-12-15
### It should lok something like this:
  # SELECT * FROM moneris_fields WHERE date_stamp >= 2020-12-01 AND date_stamp <= 2020-12-15 ORDER BY id 
